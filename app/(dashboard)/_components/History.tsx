...
function History({ userSettings }: { userSettings: UserSettings }) {
    ...
    return (
        <div className="container">
            <h2 className="pb-6 mt-12 text-3xl font-bold">History</h2>
            <Card className="col-span-12 mt-2 w-full">
                ...
                <CardContent>
                    <SkeleteonWrapper isLoading={historyDataQuery.isFetching}>
                        {dataAvailable && (
                        ...
                        {!dataAvailable && (
                            <Card className="flex h-[300px] flex-col items-center justify-center bg-background">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Try selecting a different period or adding new transcations
                                </p>
                            </Card>
                        )}
                    </SkeleteonWrapper>
...
function CustomTooltip({ active, payload, formatter }: any) {
    ...
    return (
        <>
            <div className="min-w-[300px] rounded border bg-brackground p-4">
                <TooltipRow
                    formatter={formatter}
                    label="Expense"
                    value={expense}
